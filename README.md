...
Check out a <a href="https://gallery.chrissnell.com" target="_blank">live Purtypics gallery</a> or check out our [themes](THEMES.md).
...
<table>
<tr>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/album-editor-drag-n-drop.png"><img src=".assets/screenshots/thumbs/album-editor-drag-n-drop.png" alt="Album Editor"></a>
</td>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/edit-photo.png"><img src=".assets/screenshots/thumbs/edit-photo.png" alt="Photo Editor"></a>
</td>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/gallery-settings.png"><img src=".assets/screenshots/thumbs/gallery-settings.png" alt="Gallery Settings"></a>
</td>
</tr>
<tr>
...
<tr>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/rsync-upload.png"><img src=".assets/screenshots/thumbs/rsync-upload.png" alt="Rsync Deployment"></a>
</td>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/aws-s3-upload.png"><img src=".assets/screenshots/thumbs/aws-s3-upload.png" alt="S3 Deployment"></a>
</td>
<td align="center" valign="top" width="33%" bgcolor="#f0f0f0">
<a href=".assets/screenshots/cloudflare-upload.png"><img src=".assets/screenshots/thumbs/cloudflare-upload.png" alt="Cloudflare Deployment"></a>
</td>
</tr>
<tr>
<td align="center" valign="top" width="33%">
...
| Platform | Installer |
|----------|-----------|
| **macOS (Apple Silicon)** | [purtypics_1.4.3_macOS_arm64.tar.gz](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics_1.4.3_macOS_arm64.tar.gz) |
| **macOS (Intel)** | [purtypics_1.4.3_macOS_x86_64.tar.gz](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics_1.4.3_macOS_x86_64.tar.gz) |
| **Linux (x86_64 deb)** | [purtypics_1.4.3_linux_amd64.deb](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics_1.4.3_linux_amd64.deb) |
| **Linux (x86_64 rpm)** | [purtypics_1.4.3_linux_amd64.rpm](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics_1.4.3_linux_amd64.rpm) |
| **Linux (arm64 deb)** | [purtypics_1.4.3_linux_arm64.deb](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics_1.4.3_linux_arm64.deb) |
| **Windows** | [purtypics-installer.exe](https://github.com/chrissnell/purtypics/releases/download/v1.4.3/purtypics-installer.exe) |
<!-- end:installer-links -->
